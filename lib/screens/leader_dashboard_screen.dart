...
import 'leader_tasks_screen.dart';
import 'leader_team_screen.dart';
...
class _LeaderDashboardScreenState extends State<LeaderDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _currentTab == 0
          ? LeaderTasksScreen(teamName: widget.teamName, userId: widget.userId)
          : _currentTab == 1
              ? LeaderTeamScreen(teamName: widget.teamName, department: widget.department)
  ...
  Widget _buildBottomNav(bool isDark) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          _navItem(Icons.assignment_rounded, tr(context, 'nav_team_tasks'), 0, isDark),
          _navItem(Icons.people_alt_rounded, tr(context, 'nav_team'), 1, isDark),
          _navItem(Icons.settings_rounded, tr(context, 'nav_team_settings'), 2, isDark),
        ],
      ),
    );
  }
