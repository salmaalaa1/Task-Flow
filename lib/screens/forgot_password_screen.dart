...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> _submit() async {
    ...
    final ok = await auth.resetPassword(email: _emailCtrl.text, newPassword: _passCtrl.text);
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  tr(context, 'reset_password'),
                  style: GoogleFonts.manrope(fontSize: 32, fontWeight: FontWeight.w800, letterSpacing: -0.5, color: context.textPrimary),
                ),
                const SizedBox(height: 8),
                Text(tr(context, 'reset_subtitle'), style: GoogleFonts.inter(fontSize: 15, color: context.textSecondary)),
                ...
                if (_success) ...[
                  ...
                  _label(tr(context, 'new_password')),
                  TextFormField(
                    controller: _passCtrl,
                    validator: AuthProvider.validatePassword,
                    obscureText: _obscure,
                    style: GoogleFonts.inter(fontSize: 15),
                    decoration: _inputDec(tr(context, 'min_6_chars'), Icons.lock_outline).copyWith(
                  ...
                  _label(tr(context, 'confirm_new_password')),
                  TextFormField(
                    controller: _confirmCtrl,
                    validator: (v) => AuthProvider.validateConfirmPassword(_passCtrl.text, v),
                    obscureText: true,
                    style: GoogleFonts.inter(fontSize: 15),
                    decoration: _inputDec(tr(context, 'reenter_new_password'), Icons.lock_outline),
                  ),
