...
class OwnerTeamScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    teamProv.watchTeamMembers(teamProv.teamId);
    tp.watchTeamTasks(
      teamId: teamProv.teamId,
      createdByUserId: teamProv.userId,
      createdByRole: 'owner',
    );
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 14),
                    _performanceRow(
                      tr(context, 'team_members'),
                      '${teamProv.members.length}',
  ...
  void _confirmRemoveMember(BuildContext context, String name) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
        title: Text(
          '${tr(ctx, 'remove_member_q_prefix')}$name${tr(ctx, 'remove_member_q_suffix')}',
          style: GoogleFonts.manrope(fontWeight: FontWeight.w700),
        ),
        content: Text(
          tr(ctx, 'remove_member_msg'),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setState) {
          ...
          final members = ctx.watch<TeamProvider>().memberInfos;
                ...
                Flexible(
                  child: ListView.separated(
                    ...
                    separatorBuilder: (_, __) =>
                        Divider(height: 1, color: ctx.cardBorder),
                    itemBuilder: (_, i) {
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  gradient: LinearGradient(
                                    colors: [
                                      _avatarColor(i),
                                      _avatarColor(i).withValues(alpha: 0.7),
                                    ],
                                  ),
                                ),
                                child: Center(
  ...
  void _sendTask() {
    ...
    widget.onTaskCreated(
      TeamTask(
        ...
        assignedTo: widget.member.name,
        assignedToUserId: widget.member.userId,
      ),
    );
    setState(() => _sent = true);
        ...
        body: Center(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${tr(context, 'assigned_to')} ${widget.member.name}',
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.inter(
                              fontSize: 14,
                              color: _toDate != null ? textPrimary : labelColor,
                            ),
                          ),
                          const Spacer(),
                          Icon(
