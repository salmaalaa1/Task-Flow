      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          width: 6,
                          height: 6,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: liveTask.priorityColor),
                        ),
                        const SizedBox(width: 6),
                        Text(
                          '${taskPriorityLabel(context, liveTask.priority)} ${tr(context, 'priority')}',
                  ...
                  Text(
                    liveTask.title,
                    style: GoogleFonts.manrope(fontSize: 28, fontWeight: FontWeight.w800, letterSpacing: -0.5, height: 1.2, color: context.textPrimary),
                  ),
                ],
              ),
            ),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(liveTask.isCompleted ? Icons.check_circle : Icons.radio_button_unchecked, size: 20, color: liveTask.isCompleted ? AppColors.lowGreen : AppColors.primary),
                      const SizedBox(width: 8),
                      Text(
                        liveTask.isCompleted ? tr(context, 'completed') : tr(context, 'mark_complete'),
                        style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w600, color: liveTask.isCompleted ? AppColors.lowGreen : AppColors.primary),
                      ),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: _card(context, [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w400, height: 1.6, color: context.textSecondary),
                  ),
                ]),
              ),
            const SizedBox(height: 20),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Row(children: [_infoChip(context, Icons.schedule, liveTask.formattedTime)]),
            ),
            const SizedBox(height: 12),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Row(
                children: [
                  _infoChip(context, liveTask.categoryIcon, taskCategoryLabel(context, liveTask.category)),
                  const SizedBox(width: 12),
                  _infoChip(context, Icons.flag, '${taskPriorityLabel(context, liveTask.priority)} ${tr(context, 'priority')}'),
                ],
              ),
            ),
                ...
                child: _card(context, [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${liveTask.completedChecklistCount}/${liveTask.checklist.length}',
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                item.title,
                                style: GoogleFonts.inter(fontSize: 14, fontWeight: FontWeight.w500, color: item.isCompleted ? context.textSecondary : context.textPrimary, decoration: item.isCompleted ? TextDecoration.lineThrough : null),
                              ),
                            ),
                          ],
                        ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: Text(tr(context, 'cancel'), style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
          ),
          TextButton(
            onPressed: () {
