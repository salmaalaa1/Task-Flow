              ...
              children: ['All', 'Today', 'Upcoming', 'Done'].map((label) {
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      tr(context, filterKeys[label]!),
                      style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: isActive ? Colors.white : context.textSecondary),
                    ),
                  ),
                );
              }).toList(),
              ...
              child: Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      tr(context, 'no_tasks_found'),
                      style: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w700, color: context.textSecondary),
                    ),
                      ...
                      children: [
                        Row(
                          children: [
                            Expanded(
                              child: Text(
                                task.title,
                                style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w700, color: context.textPrimary, decoration: task.isCompleted ? TextDecoration.lineThrough : null),
                              ),
                            ),
                            Container(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, color: task.priorityColor),
                              ),
                            ),
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              taskCategoryLabel(context, task.category),
                              style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w500, color: context.textSecondary.withValues(alpha: 0.6)),
                            ),
                          ],
                        ),
